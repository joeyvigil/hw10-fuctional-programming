...
premium_customers  =  list(filter(lambda customer: True if customer['vip_member']==True else ( True if (customer['total_spent'] >= 1000 and customer['orders'] >= 5 ) else False) , customers))
